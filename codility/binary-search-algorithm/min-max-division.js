...
function minimalLargeSumBinarySearch(maxNumBlocks, arra) {
  var lowerBoundLargeSum = Math.max.apply(null, arra); // largest number in the array
  var upperBoundLargeSum = arra.reduce((a,c)=>a+c,0); // total sum of all numbers in array
  var result = -1;
